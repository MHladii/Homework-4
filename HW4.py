...
character1_lines = read_lines_from_file('chapter1.txt')
character2_lines = read_lines_from_file('chapter2.txt')

if not character1_lines:
    print("No content found in chapter1.txt.")
if not character2_lines:
    print("No content found in chapter2.txt.")
